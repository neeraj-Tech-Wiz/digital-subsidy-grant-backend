...
/**
 * Beneficiary applicant profile data model used for evaluating scheme eligibility rules.
 */
public class BeneficiaryProfile implements Serializable {
    ...
    // Dynamic key-value pairs for scheme-specific custom parameters
    private Map<String, Object> attributes = new HashMap<>();

    public BeneficiaryProfile() {
    }

    public BeneficiaryProfile(Long id, String name, int age, String aadhaarNumber, String mobileNumber,
